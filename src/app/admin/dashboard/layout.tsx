    ...
    <div className="">
      <SidebarProvider>
        ...
        <SidebarInset className=" lg:py-2 lg:px-3 dark:bg-slate-800 bg-white ">
          <Header />
          <div className="flex flex-1 flex-col gap-4 lg:p-8 pt-0 bg-white dark:bg-slate-900 rounded-lg border-x border-b shadow-[-4px_5px_10px_0px_rgba(0,_0,_0,_0.1)]">
