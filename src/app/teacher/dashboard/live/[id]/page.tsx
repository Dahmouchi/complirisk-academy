    ...
    return (
      <div className="h-screen flex items-center justify-center flex-col gap-4 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        <div className="relative">
          <div className="absolute inset-0 bg-[#1A3263]/20 blur-3xl rounded-full"></div>
          <Loader2 className="h-12 w-12 animate-spin text-[#1A3263] relative" />
        </div>
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-8 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        <div className="text-center space-y-4 max-w-md">
          <div className="p-4 bg-[#1A3263]/10 rounded-full inline-block">
            <Video className="h-16 w-16 text-[#1A3263]" />
          </div>
        ...
        <div className="flex flex-col gap-4">
          <Button
            size="lg"
            onClick={handleStart}
            className="gap-2 bg-gradient-to-r from-[#1A3263] to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-6 text-lg shadow-xl"
          >
  ...
  if (status === "SCHEDULED" && !isTeacher) {
    return (
      <div className="h-screen flex flex-col items-center justify-center gap-6 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        <Loader2 className="h-12 w-12 animate-spin text-[#1A3263]" />
