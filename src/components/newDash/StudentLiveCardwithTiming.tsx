...
export function StudentLiveCardWithTiming({
  ...
  useEffect(() => {
    if (room.status === "SCHEDULED" && room.startsAt) {
      ...
      // If time has already passed on mount, do not start the interval/refresh loop
  ...
  const getStatusConfig = () => {
    switch (room.status) {
      ...
      case "SCHEDULED":
        return {
          label: "Programmé",
          color: "bg-[#1A3263] hover:bg-blue-600",
          icon: "scheduled",
        };
      case "ENDED":
        return {
        ...
        <div className="flex items-start justify-between flex-col lg:flex-row">
          ...
          <div className="lg:mt-0 mt-2">
            ...
            {room.status === "SCHEDULED" && (
              <div className="flex items-center gap-1.5 bg-gradient-to-r from-[#1A3263] to-blue-700 text-white px-4 py-1.5 rounded-full text-xs font-bold shadow-lg">
              ...
              {registered ? (
                <Button
                  ...
                  className={cn(
                    ...
                    "border-[#1A3263] text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/20",
